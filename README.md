# HealthSummary-AI-
HealthSummary AI — AI-система на Go для анализа медицинской истории пациента. Создает "медицинскую биографию" на основе анализов. Pet-project с фокусом на приватность данных. Основной язык: Go.
